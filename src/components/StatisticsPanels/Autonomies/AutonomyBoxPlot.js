...
function AutonomyBoxPlot(props) {
  ...
  const options: Highcharts.Options = {
    ...
    title: null,
    xAxis: {
      categories: [t("AutonomyBoxPlot.category")],
      title: null
    },
    yAxis: {
      title: {
        text: t("AutonomyBoxPlot.autonomy")
      }
    },
    series: [
      {
        name: t("AutonomyBoxPlot.all"),
        data: [generalSeries]
      },
      {
        name: t("AutonomyBoxPlot.male"),
        data: [maleSeries]
      },
      {
        name: t("AutonomyBoxPlot.female"),
        data: [femaleSeries]
      }
    ],
...
export default AutonomyBoxPlot;
